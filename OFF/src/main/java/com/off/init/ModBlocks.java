...
public class ModBlocks
{
	...
	*/
	...
	public static Float defaultResistance = 30.0F;
	...
	// Ores
	public static final Block ORE_SMOKE = new BlockOre("ore_smoke", defaultMaterial, defaultHardness, defaultResistance);
	public static final Block ORE_SMOKE_EMPTY = new BlockOre("ore_smoke_empty", Material.ROCK, 0.5F, 0.5F);
	public static final Block ORE_METAL = new BlockBase("ore_metal", defaultMaterial, defaultSound, defaultHardness, defaultResistance, defaultToolType, defaultHarvestLevel);

	// Generating blocks
	public static final Block DIRT = new BlockBase("dirt", Material.GROUND, SoundType.GROUND, 0.5F, 0.5F, "shovel", 0);
	public static final Block ROCK = new BlockBase("rock", defaultMaterial, defaultSound, defaultHardness, defaultResistance, defaultToolType, defaultHarvestLevel);
