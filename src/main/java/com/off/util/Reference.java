...
{
    public static final String MODID = "off";
    public static final String MODNAME = "OFF";
    public static final String VERSION = "0.0.1.1a";
    ...
    public static final int GUI_KILN = 1;
}
